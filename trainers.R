...
my_trainer <- Trainer_classification$new(medical.train, medical.test, "UCURNINS")
...
my_trainer <- Trainer_regression$new(medical.train, medical.test, "U_USHRS")
results <- my_trainer$create_random_forest(my_trainer$train_data, 
                                           my_trainer$test_data,
                                           formula = model1.formula,
                                           method = "ranger",
                                           ...
                                           mtry = 15,
                                           min_node_size = 200)
plots <- my_trainer$actual_vs_predicted(my_trainer$predictions)
a_p <- plots[1]
residuals <- plots[2]
a_p
residuals
...
plots <- my_trainer$plot_metrics(metrics)
